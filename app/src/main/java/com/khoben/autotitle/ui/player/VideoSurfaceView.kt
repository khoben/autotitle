    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (mVideoWidth > 0 && mVideoHeight > 0) {
            ...
            if (widthSpecMode == MeasureSpec.EXACTLY && heightSpecMode == MeasureSpec.EXACTLY) {
                ...
                Log.i(TAG, "Video source: $mVideoWidth x $mVideoHeight")
                if (
                    ...
                    Log.i(TAG, "AT_MOST ${width}x${height} (scale factor:$scale)")
                    ...
                    Log.i(TAG, "AT_MOST ${width}x${height}, fit height with source aspect ratio")
                    ...
                    Log.i(TAG, "AT_MOST ${width}x${height}, fit width with source aspect ratio")
                }
            }
        } else {
