...
internal class MultiTouchListener(
    ...
    photoEditImageView: RelativeLayout, private val mIsTextPinchZoomable: Boolean,
    ...
    private val photoEditImageView: RelativeLayout
    ...
    private fun firePhotoEditorSDKListener(view: View, isStart: Boolean) {
        ...
        if (mOnPhotoEditorListener != null && viewTag != null && viewTag is OverlayType) {
