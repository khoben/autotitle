package com.khoben.autotitle.huawei.ui.overlay.gesture
...
interface OnPhotoEditorListener {
     ...
     * @see ViewType
     */
    fun onAddViewListener(viewType: OverlayType?, numberOfAddedViews: Int)
     ...
     * @param numberOfAddedViews number of views currently added
     */
    fun onRemoveViewListener(viewType: OverlayType?, numberOfAddedViews: Int)
     ...
     * @param viewType enum which define type of view is added
     */
    fun onStartViewChangeListener(viewType: OverlayType?)
     ...
     * @param viewType enum which define type of view is added
     */
    fun onStopViewChangeListener(viewType: OverlayType?)
}
